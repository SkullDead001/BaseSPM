...
// 📌 Función auxiliar para formatear hora en distintas zonas
...
module.exports = {
  name: '6v6clk',
  alias: [],
  description: 'Muestra plantilla 6v6 modo CLK con horarios internacionales (solo admins)',
  noCooldown: true,
...
`;
      ...
      console.error('[6v6clk ERROR]', err);
